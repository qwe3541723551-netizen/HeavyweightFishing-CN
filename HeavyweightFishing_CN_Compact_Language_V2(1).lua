...
winControls.Size = UDim2.new(0, 160, 1, 0)
winControls.Position = UDim2.new(1, -165, 0, 0)
local langBtn = Instance.new("TextButton")
langBtn.Name = "LanguageButton"
langBtn.Size = UDim2.new(0, 56, 0, 24)
langBtn.Position = UDim2.new(0, 96, 0.5, -12)
langBtn.BackgroundColor3 = Colors.ControlBg
langBtn.Font = Enum.Font.GothamBold
langBtn.Text = "中文"
langBtn.TextColor3 = Colors.PurplePrimary
langBtn.TextSize = 10
langBtn.BorderSizePixel = 0
langBtn.Parent = winControls
Instance.new("UICorner", langBtn).CornerRadius = UDim.new(0, 4)
Instance.new("UIStroke", langBtn).Color = Colors.BorderSubtle


-- ============================================================
-- UI SCALE + LANGUAGE SWITCH (中文 / English / Tiếng Việt)
-- ============================================================
local I18N = {
    ["Heavyweight Fishing | Việt Hoá V1.1"] = "Heavyweight Fishing｜中文 V2",
    ["[R-CTRL] Menu | [END] Tắt Script"] = "[R-CTRL] 菜单｜[END] 停止脚本",
    ["HEAVYWEIGHT FISHING | BẢN VIỆT HOÁ"] = "HEAVYWEIGHT FISHING｜中文版",
    ["CÂU CÁ PRO"] = "钓鱼 PRO",
    ["Diệt Script"] = "停止脚本",
    ["Đang ngắt kết nối và đóng script hoàn toàn..."] = "正在停止并关闭脚本……",
    ["Câu Cá"] = "钓鱼",
    ["Săn Boss"] = "Boss 狩猎",
    ["Quản Lý Cá"] = "鱼类管理",
    ["Thần Linh"] = "神灵",
    ["Nhiệm Vụ"] = "任务",
    ["Shop & Chế Mồi"] = "商店 & 制作鱼饵",
    ["Dịch Chuyển"] = "传送",
    ["ESP & Đồ Hoạ"] = "ESP & 画质",
    ["Nhân Vật"] = "角色",
    ["Cài Đặt"] = "设置",
    ["Thử Nghiệm"] = "实验",
    ["Thông Tin Tài Khoản & Thống Kê"] = "账号信息 & 统计",
    ["Tiếng Việt"] = "越南语",
    ["English"] = "English",
    ["中文"] = "中文",
    ["Việt Nam"] = "越南语",
    ["Quét Lại Balo"] = "重新扫描背包",
    ["Quét Hoàn Tất"] = "扫描完成",
    ["Đã đồng bộ toàn bộ số liệu Balo vào Tab Quản Lý Cá!"] = "背包数据已同步到「鱼类管理」！",
    ["Đang Dùng"] = "使用中",
    ["ĐÃ CÓ"] = "已拥有",
    ["Mua Cần"] = "购买鱼竿",
    ["Bay Đến"] = "传送",
    ["Tự Động Quăng Cần (Auto Cast)"] = "自动抛竿",
    ["Độ Trễ Quăng Cần"] = "抛竿延迟",
    ["Giữ Thanh Minigame (Anchor Bar)"] = "锁定小游戏进度条",
    ["Tự Dùng Kỹ Năng Cần"] = "自动使用鱼竿技能",
    ["Tự Động Đập Cần (Auto Slam)"] = "自动猛拉鱼竿",
    ["Tự Động Sạc Dây (Auto Charge)"] = "自动蓄力",
    ["Tự Động Chống Kẹt Cần (Anti-Stuck)"] = "自动防卡竿",
    ["Bật Combo Kỹ Năng Tự Động"] = "启用自动技能连招",
    ["Ngưỡng Máu Cá Phân Loại"] = "鱼血量分界",
    ["Chiêu Bắt Nhanh (<= Ngưỡng HP)"] = "快速捕获技能（≤血量阈值）",
    ["Chiêu Mở Màn (> Ngưỡng HP)"] = "开场技能（>血量阈值）",
    ["Số Lần Dùng Chiêu Mở Màn"] = "开场技能使用次数",
    ["Chuỗi Đảo Chiêu Luân Phiên"] = "循环技能序列",
    ["Tùy Biến Chuỗi Đảo Chiêu"] = "自定义技能序列",
    ["Mẫu Chuỗi Chiêu (Preset)"] = "技能序列预设",
    ["Giữ Đúng Thứ Tự Combo (Strict Order)"] = "严格按顺序连招",
    ["Chiêu Hồi Máu / Cứu Nguy"] = "回血/保命技能",
    ["Kích Hoạt Hồi Máu Khi HP Dưới"] = "低于此 HP 时回血",
    ["Thời Gian Chờ Ra Chiêu"] = "技能释放延迟",
    ["Tự Động Nhận Diện Hết Hiệu Ứng"] = "自动识别技能效果",
    ["Bật Auto Luyện Chiêu"] = "启用自动练技能",
    ["Chọn Chiêu Cần Luyện"] = "选择练习技能",
    ["Nhịp Chờ Xuất Chiêu (Cancel Delay)"] = "技能取消延迟",
    ["Mục Tiêu Số Lần Dùng"] = "目标使用次数",
    ["Tự Động Bán Cá Khi Đầy Túi"] = "背包满时自动卖鱼",
    ["Giãn Cách Bán Cá Tự Động"] = "自动卖鱼间隔",
    ["Tự Động Khóa Cá Đột Biến (Mutations)"] = "自动保护变异鱼",
    ["Tự Động Gom Cá Nguyên Liệu (Crafting)"] = "自动收集制作材料鱼",
    ["Tự Động Khóa Cá Yêu Thích"] = "自动锁定收藏鱼",
    ["Tên Loài Cá Cần Khóa"] = "要锁定的鱼名",
    ["Tự Động Trang Bị Cần Tốt Nhất"] = "自动装备最佳鱼竿",
    ["Tự Dùng Cần Tốt Nhất"] = "使用最佳鱼竿",
    ["Tự Động Trang Bị Mồi"] = "自动装备鱼饵",
    ["Tự Dùng Mồi (Auto Bait)"] = "自动使用鱼饵",
    ["Tự Dùng Mồi Tốt Nhất"] = "使用最佳鱼饵",
    ["Chọn Mồi Khi Câu Thường"] = "普通钓鱼鱼饵",
    ["Tự Đổi Mồi Khi Săn Boss"] = "Boss 狩猎自动换饵",
    ["Chọn Mồi Săn Boss"] = "Boss 狩猎鱼饵",
    ["Tự Động Trang Bị Pháp Bảo Tốt Nhất"] = "自动装备最佳法宝",
    ["Tự Dùng Ngọc Tốt Nhất"] = "使用最佳法宝",
    ["Bật Chế Độ Săn Boss (Tự Quăng Cần & Lọc Cá)"] = "启用 Boss 狩猎（自动抛竿/筛鱼）",
    ["Bật Săn Secret Boss (Chat Sniper)"] = "启用 Secret Boss 聊天狙击",
    ["Tự Động Săn Secret Boss Theo Chat"] = "根据聊天自动狩猎 Secret Boss",
    ["Giật Cần Thả Lại (Fast Skip Cá Thường)"] = "快速跳过普通鱼",
    ["Bỏ Qua Cá Thường (Fast Skip)"] = "跳过普通鱼",
    ["Kiểm Tra Lực Cần (Power Check)"] = "检查鱼竿力度",
    ["Chỉ Săn Khi Đủ Lực Cần (Power Check)"] = "仅在力度足够时狩猎",
    ["Tự Đổi Server Khi Hết Boss (Auto-Hop)"] = "Boss 消失后自动换服",
    ["Đổi Server Khi Hết Secret Boss"] = "Secret Boss 消失后换服",
    ["Tự Về Vị Trí Farm Khi Hết Boss / Clear"] = "Boss 清空后返回 Farm 点",
    ["Tự Động Tìm Server Thời Tiết"] = "自动寻找天气服务器",
    ["Chọn Thời Tiết Cần Tìm"] = "目标天气",
    ["Tự Động Câu / Săn Boss Khi Tìm Thấy"] = "找到后自动钓鱼/狩猎 Boss",
    ["Gửi Webhook Khi Tìm Thấy Server"] = "找到服务器时发送 Webhook",
    ["Tự Động Quét Trạng Thái Thần Linh"] = "自动检测神灵状态",
    ["Tự Động Cầu Nguyện Thần Linh"] = "自动祈祷神灵",
    ["Đổi Server Tìm Thần Linh"] = "换服寻找神灵",
    ["Đổi Server Tìm Maoshan"] = "换服寻找 Maoshan",
    ["Đổi Server Tìm Đạo Sĩ (Taoist)"] = "换服寻找道士",
    ["Đổi Server Tìm Taoist"] = "换服寻找 Taoist",
    ["Tự Động Nộp Vé Nhiệm Vụ (Tickets)"] = "自动提交任务票",
    ["Chọn Độ Khó Vé Nhiệm Vụ"] = "任务票难度",
    ["Chế Độ Nhiệm Vụ"] = "任务模式",
    ["Loại Mồi Làm Nhiệm Vụ 100 Mồi"] = "100 鱼饵任务类型",
    ["Chiêu Dùng Cho Nhiệm Vụ 100 Skill"] = "100 条鱼任务技能",
    ["Chiêu Giật Nhanh Cho 100 Con Cá"] = "100 条鱼快速技能",
    ["Thời Gian Hồi Chiêu (Phút)"] = "冷却时间（分钟）",
    ["Tự Bán Cá Khi Đầy Balo (Vé NV)"] = "任务票背包满时自动卖鱼",
    ["Tự Về Home Spot Khi Xong Nhiệm Vụ"] = "任务完成后返回 Home 点",
    ["Tự Động Quăng Cần Tại Home Spot"] = "在 Home 点自动抛竿",
    ["Nhận & Nộp Vé Từ Xa (Remote)"] = "远程领取/提交任务票",
    ["Tự Động Nhận Thưởng Hàng Ngày (Daily)"] = "自动领取每日奖励",
    ["Vòng Quay May Mắn (Auto Gacha)"] = "自动抽奖",
    ["Chọn Vòng Quay Gacha"] = "选择抽奖池",
    ["Số Vé Mỗi Lần Quay"] = "每次抽奖票数",
    ["Bật Quản Lý Độ Ưu Tiên"] = "启用优先级管理",
    ["Mẫu Phân Cấp (Preset)"] = "优先级预设",
    ["ESP Thần Linh (God Spirit)"] = "ESP 神灵",
    ["ESP Cần Câu Bí Mật"] = "ESP 秘密鱼竿",
    ["ESP Thuyền Bè"] = "ESP 船只",
    ["ESP Maoshan"] = "ESP Maoshan",
    ["ESP Đạo Sĩ (Taoist)"] = "ESP 道士",
    ["ESP Trùm Boss"] = "ESP Boss",
    ["ESP Người Chơi"] = "ESP 玩家",
    ["Vòng Tròn Định Vị Cá"] = "鱼类定位圈",
    ["Hiện Cân Nặng & Đột Biến Trên Vòng Đỏ"] = "在红圈显示重量/变异",
    ["Tầm Nhìn Xa (Xóa Mờ Map)"] = "远距离视野",
    ["Xóa Sương Mù & Mưa Bão"] = "移除雾/暴雨效果",
    ["Sáng Màn Hình (Fullbright)"] = "全亮",
    ["Mức Độ Sáng (Fullbright)"] = "亮度等级",
    ["Chống Lóa Thời Tiết (Anti-Glare)"] = "天气防眩光",
    ["Chế Độ Giảm Lag (Low GFX)"] = "低画质减负",
    ["Ẩn Giao Diện Gốc Của Game"] = "隐藏游戏原 UI",
    ["Ẩn Tên Mặc Định Người Chơi"] = "隐藏玩家默认名称",
    ["Tăng Tốc Độ Chạy (Speed)"] = "提高移动速度",
    ["Chỉnh Tốc Độ"] = "移动速度",
    ["Bay Lượn Tự Do (Fly)"] = "自由飞行",
    ["Tốc Độ Bay"] = "飞行速度",
    ["Nhảy Vô Hạn (Infinite Jump)"] = "无限跳跃",
    ["Đi Trên Mặt Nước"] = "水上行走",
    ["Khiên Nước Axit (Acid Shield)"] = "酸水护盾",
    ["Đi Xuyên Tường (Noclip)"] = "穿墙",
    ["Chống Văng Game (Anti-AFK)"] = "防 AFK",
    ["Tự Động Kết Nối Lại"] = "自动重连",
    ["Bật Webhook"] = "启用 Webhook",
    ["Thông Báo Bắt Được Boss"] = "Boss 捕获通知",
    ["Thông Báo Đạo Sĩ (Taoist & Maoshan)"] = "道士/Taoist/Maoshan 通知",
    ["Báo Cáo Định Kỳ"] = "定期报告",
    ["Thông Báo Hoàn Thành Nhiệm Vụ Vé"] = "任务票完成通知",
    ["Tần Suất Báo Cáo Định Kỳ"] = "报告间隔",
    ["Bật Telegram Bot"] = "启用 Telegram Bot",
    ["Telegram Báo Boss"] = "Telegram Boss 通知",
    ["Telegram Báo Đạo Sĩ"] = "Telegram 道士通知",
    ["Bật ntfy Push"] = "启用 ntfy 推送",
    ["Thông Báo Đổi Thời Tiết (ntfy)"] = "天气变化通知",
    ["Thông Báo Tìm Server Thời Tiết (ntfy)"] = "天气服务器通知",
    ["Thông Báo Boss & NPC (ntfy)"] = "Boss/NPC 通知",
    ["Hiện Bảng Sát Thương Boss (% HP)"] = "显示 Boss 伤害面板（% HP）"
}

local CurrentLanguage = "zh"
local LanguageOrder = {"zh", "en", "vi"}
local LanguageNames = {zh = "中文", en = "EN", vi = "VI"}

local function I18nLookup(text, lang)
    if not text or text == "" then return text end
    if lang == "vi" then return text end
    if lang == "zh" then return I18N[text] or text end
    -- English fallback: keep original Vietnamese for strings not explicitly translated.
    local zhText = I18N[text] or text
    local en = {
        ["钓鱼"]="Fishing", ["Boss 狩猎"]="Boss Hunt", ["鱼类管理"]="Fish Manager",
        ["神灵"]="God Spirit", ["任务"]="Quests", ["商店 & 制作鱼饵"]="Shop & Bait",
        ["传送"]="Teleport", ["ESP & 画质"]="ESP & Visuals", ["角色"]="Player",
        ["设置"]="Settings", ["实验"]="Experimental", ["账号信息 & 统计"]="Account & Stats",
        ["停止脚本"]="Stop Script", ["正在停止并关闭脚本……"]="Stopping script...",
        ["重新扫描背包"]="Rescan Bag", ["扫描完成"]="Scan Complete",
        ["钓鱼 PRO"]="FISHING PRO", ["中文"]="Chinese", ["越南语"]="Vietnamese"
    }
    return en[zhText] or zhText
end
...
local function ApplyLanguage(lang)
    ...
    for _, obj in ipairs(screenGui:GetDescendants()) do
        if obj:IsA("TextLabel") or obj:IsA("TextButton") then
            local src = obj:GetAttribute("I18nSource")
            if not src then
                src = obj.Text
                if src and src ~= "" then pcall(function() obj:SetAttribute("I18nSource", src) end) end
            end
            if src and src ~= "" then obj.Text = I18nLookup(src, CurrentLanguage) end
        elseif obj:IsA("TextBox") then
            local src = obj:GetAttribute("I18nPlaceholder")
            if not src then
                src = obj.PlaceholderText
                if src and src ~= "" then pcall(function() obj:SetAttribute("I18nPlaceholder", src) end) end
            end
            if src and src ~= "" then obj.PlaceholderText = I18nLookup(src, CurrentLanguage) end
        end
    end
end
...
local function NextLanguage()
    local idx = 1
    for i, v in ipairs(LanguageOrder) do if v == CurrentLanguage then idx = i break end end
    idx = idx % #LanguageOrder + 1
    return LanguageOrder[idx]
end

langBtn.MouseButton1Click:Connect(function()
    local nextLang = NextLanguage()
    ApplyLanguage(nextLang)
    langBtn.Text = LanguageNames[nextLang]
end)
